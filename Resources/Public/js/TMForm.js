...
(function($){
	$.fn.TMForm=function(opt){
		...
		function TMForm(){
			...
			function init(){				
				form
					...
					.on('blur','[data-constraints]:not(.once-verified)',function(){
						$(this)
							...
							.trigger('validate.form.html')
					})
					.on('keyup','[data-constraints].once-verified',function(){						
						$(this).trigger('validate.form.html')
					})					
				...
				if($('[data-constraints]',form).length!==0)
					$('[data-constraints]',form)
						...
						.on('validate.form.html',fieldValidate)
			...
			function formSubmit(){
				$('[data-constraints]',form).trigger('validate.form.html')
...
/*
 ...
 Written By Vivin Paliath (../http/MS_11.html)
 License: BSD License
